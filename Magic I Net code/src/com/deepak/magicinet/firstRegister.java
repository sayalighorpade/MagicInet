...
public class firstRegister extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ed1 = (EditText) findViewById(R.id.usernameedit);
		ed2 = (EditText) findViewById(R.id.passwardeditt);
		ed3 = (EditText) findViewById(R.id.confirmedit);

		b1 = (Button) findViewById(R.id.success);
		b2 = (Button) findViewById(R.id.exitbtn);
		ck = (CheckBox) findViewById(R.id.checkedit);
